...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        rippleColor = a
                .getColor(R.styleable.MaterialRippleLayout_materialRippleColor, DEFAULT_COLOR);
        ...
        rippleOverlay = a
                .getBoolean(R.styleable.MaterialRippleLayout_rippleOverlay, DEFAULT_RIPPLE_OVERLAY);
        ...
        rippleAlpha = (int) (255 *
                a.getFloat(R.styleable.MaterialRippleLayout_rippleAlpha, DEFAULT_ALPHA));
        rippleDelayClick = a
                .getBoolean(R.styleable.MaterialRippleLayout_rippleDelayClick, DEFAULT_DELAY_CLICK);
        ...
        ripplePersistent = a
                .getBoolean(R.styleable.MaterialRippleLayout_ripplePersistent, DEFAULT_PERSISTENT);
    ...
    private void startHover() {
        ...
        final float radius = (float) (
                Math.sqrt(Math.pow(getWidth(), 2) + Math.pow(getHeight(), 2)) * 1.2f);
    ...
    private float getEndRadius() {
        ...
        final float radiusX =
                halfWidth > currentCoords.x ? width - currentCoords.x : currentCoords.x;
        final float radiusY =
                halfHeight > currentCoords.y ? height - currentCoords.y : currentCoords.y;
    ...
    * Accessor
    ...
    private class PerformClickEvent implements Runnable {
        ...
        private void clickAdapterView(AdapterView<?> parent) {
            ...
            final long itemId =
                    parent.getAdapter() != null ? parent.getAdapter().getItemId(position) : 0;
